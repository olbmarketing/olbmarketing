...
Student.create!(school_year: '2016-17',new_or_return: '',student_class: 'PS',last_name: 'Alo',first_name: 'Janie',father_name: 'Michael',mother_name: 'Elizabeth',address: '',city: '',state: '',zip: '',email1: 'not listed',email2: 'elizabeth@vitalwork.com',catholic: '',parish: '',race: '',resides_with: '',reference_from: '')
Student.create!(school_year: '2016-17',new_or_return: 'Return',student_class: 'AMPreK',last_name: 'Bakhshi',first_name: 'Juliet',father_name: 'Aaron',mother_name: 'Susan',address: '58 West Riverglen Drive',city: 'Worthington',state: 'OH',zip: '43085',email1: 'aaron@burkeproducts.com',email2: 'suzg8@hotmail.com',catholic: 'Y',parish: 'St. Michael',race: 'White/Caucasian',resides_with: 'Both',reference_from: 'Current / Alumni Family')
...
Student.create!(school_year: '2016-17',new_or_return: 'Return',student_class: 'AMPreK',last_name: 'Brehm',first_name: 'Emily',father_name: 'Michael',mother_name: 'Andrea',address: '107 West Cooke Road',city: 'Columbus',state: 'OH',zip: '43214',email1: 'mbrehm6@yahoo.com',email2: 'andrea_dejohn@att.net',catholic: 'Y',parish: 'OLP',race: 'White/Caucasian',resides_with: 'Both',reference_from: 'Current / Alumni Family')
