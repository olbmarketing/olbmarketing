...
class StarReadingTestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should destroy star_reading_test" do
    ...
    assert_redirected_to star_reading_tests_url
  end
end
