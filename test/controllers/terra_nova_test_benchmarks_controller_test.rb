...
class TerraNovaTestBenchmarksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create terra_nova_test_benchmark" do
    assert_difference('TerraNovaTestBenchmark.count') do
      post terra_nova_test_benchmarks_url, params: { terra_nova_test_benchmark: { basic_understanding_opi: @terra_nova_test_benchmark.basic_understanding_opi, geometry_and_spatial_sense_opi: @terra_nova_test_benchmark.geometry_and_spatial_sense_opi, data_stats_and_probability_opi: @terra_nova_test_benchmark.data_stats_and_probability_opi, introduction_to_print_opi: @terra_nova_test_benchmark.introduction_to_print_opi, measurement_opi: @terra_nova_test_benchmark.measurement_opi, number_and_number_relations_opi: @terra_nova_test_benchmark.number_and_number_relations_opi, oral_comprehension_opi: @terra_nova_test_benchmark.oral_comprehension_opi, basic_understanding_moderate_mastery_range: @terra_nova_test_benchmark.basic_understanding_moderate_mastery_range, geometry_and_spatial_sense_moderate_mastery_range: @terra_nova_test_benchmark.geometry_and_spatial_sense_moderate_mastery_range, data_stats_and_probability_moderate_mastery_range: @terra_nova_test_benchmark.data_stats_and_probability_moderate_mastery_range, introduction_to_print_moderate_mastery_range: @terra_nova_test_benchmark.introduction_to_print_moderate_mastery_range, measurement_moderate_mastery_range: @terra_nova_test_benchmark.measurement_moderate_mastery_range, number_and_number_relations_moderate_mastery_range: @terra_nova_test_benchmark.number_and_number_relations_moderate_mastery_range, oral_comprehension_moderate_mastery_range: @terra_nova_test_benchmark.oral_comprehension_moderate_mastery_range, test_date: @terra_nova_test_benchmark.test_date } }
    end
